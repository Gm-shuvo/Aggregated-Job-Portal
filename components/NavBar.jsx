...
export default function NavBar() {
    ...
    return (
        <>
            <div className={`w-full ${scrolled ? "bg-indigo-600/70" : "bg-indigo-600"} px-6 h-[50px] bg-indigo-600 text-white flex items-center justify-between fixed top-0 left-0 z-50`}>
                ...
                <div className=' px-2 h-full hidden items-center justify-center lg:flex'>
                    <Link href={'/'} className="active_underline px-3 mx-4 text-base font-medium uppercase" >Home</Link>
                    ...
                    {user?.type === 'recruiter' && <Link href={'/frontend/postAJob'} className="active_underline px-3 mx-4 text-base font-medium uppercase" >Post Jobs</Link>}
                    <Link href={'/frontend/displayJobs'} className="active_underline px-3 mx-4 text-base font-medium uppercase" >View Jobs</Link>
                    {user?.type === 'recruiter' && <Link href={'/frontend/postedJob'} className="active_underline px-3 mx-4 text-base font-medium uppercase" >Posted Jobs</Link>}
                    ...
                    {user?.type === 'candidate' && <Link href={'/frontend/dashboard'} className="active_underline px-3 mx-4 text-base font-medium  uppercase" >Dashboard</Link>}
                    ...
                    <Link href={'/'} className="active_underline px-3 mx-4 text-base font-medium uppercase" >Contact</Link>
                </div>
                <div className='px-2 h-full hidden items-center justify-center lg:flex ' >
                    {
                        user !== null ? (
                    ...
                    isOpen && (
                        <div ref={ref} className='flex w-full py-2 animate-fade-in-down  bg-indigo-600 transition-all fade duration-1000 absolute top-20 left-0  items-center justify-center flex-col '>
                            <div className='px-2 h-full flex items-center justify-center flex-col py-2 '>
                                ...
                                {user  && <Link href={'/frontend/dashboard'} onClick={() => setIsOpen(false)} className="px-3 m-4 text-base font-medium transition-all duration-700 hover:translate-y-2 uppercase" >Dashboard</Link>}
